...
/* package scotty-test-0.1.0.0 */
#ifndef VERSION_scotty_test
#define VERSION_scotty_test "0.1.0.0"
#endif /* VERSION_scotty_test */
#ifndef MIN_VERSION_scotty_test
#define MIN_VERSION_scotty_test(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_scotty_test */
...
#define CURRENT_COMPONENT_ID "scotty-test-0.1.0.0-Ck1Y6vAi7GqKsFjybLSdaN-scotty"
